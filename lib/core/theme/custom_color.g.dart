...
const customcolor1 = Color(0xFFEFAD00);

CustomColors lightCustomColors = const CustomColors(
  sourceCustomcolor1: Color(0xFFEFAD00),
  customcolor1: Color(0xFF7C5800),
  onCustomcolor1: Color(0xFFFFFFFF),
  customcolor1Container: Color(0xFFFFDEA7),
  onCustomcolor1Container: Color(0xFF271900),
);

CustomColors darkCustomColors = const CustomColors(
  sourceCustomcolor1: Color(0xFFEFAD00),
  customcolor1: Color(0xFFFFBB1C),
  onCustomcolor1: Color(0xFF412D00),
  customcolor1Container: Color(0xFF5E4200),
  onCustomcolor1Container: Color(0xFFFFDEA7),
);
