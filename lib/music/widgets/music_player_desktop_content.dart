...
class MusicPlayerDesktopContent extends StatefulWidget {
  const MusicPlayerDesktopContent({
    super.key,
    required this.music,
  });
  final Music music;
  ...
  @override
  State<MusicPlayerDesktopContent> createState() =>
      _MusicPlayerDesktopContentState();
}

class _MusicPlayerDesktopContentState extends State<MusicPlayerDesktopContent>
